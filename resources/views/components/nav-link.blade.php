...
$classes = ($active ?? false)
            ? 'group flex items-center space-x-2 rounded-lg border border-primary-100 bg-primary-50 px-3 py-2 text-sm font-medium text-primary-600 dark:border-transparent dark:bg-white/10 dark:text-white'
